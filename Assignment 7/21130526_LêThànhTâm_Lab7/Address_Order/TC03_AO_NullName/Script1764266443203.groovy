...
WebUI.setText(findTestObject('Object Repository/Page_/input_()_name'), '')
...
TestObject errorObj = findTestObject('Object Repository/Page_/div_()_text-error')

String errorText = WebUI.getText(findTestObject('Object Repository/Page_/div_()_text-error'))
println("Thông báo lỗi: " + errorText)
